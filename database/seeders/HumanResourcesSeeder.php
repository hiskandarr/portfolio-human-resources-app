    ...
    public function run(): void
    {
        ...
        DB::table('tasks')->insert([
            [
                ...
                'assigned_to' => 1,
                'due_date' => Carbon::parse('2025-02-15')->toDateString(),
                'status' => 'pending',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ...
        DB::table('payrolls')->insert([
            [
                ...
                'pay_date' => Carbon::parse('2025-02-15')->toDateString(),
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
            [
        ...
        DB::table('presences')->insert([
            [
                ...
                'date' => Carbon::parse('2025-02-10')->toDateString(),
                'status' => 'present',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
        ...
        DB::table('leave_requests')->insert([
            [
                ...
                'start_date' => Carbon::parse('2025-02-20')->toDateString(),
                'end_date' => Carbon::parse('2025-02-23')->toDateString(),
                'status' => 'pending',
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ],
