...
<body>
        ...
        <div id="main">
            ...
            <footer>
                <div class="clearfix mb-0 footer text-muted">
                    ...
                    <div class="float-end">
                        <p>Crafted with <span class="text-danger"><i class="bi bi-heart-fill icon-mid"></i></span> by
    ...
    <script>
        ...
        function updateDataChartPresence() {
            fetch('/dashboard/chart-presence').then(response => response.json()).then((output) => {
                myBar.data.datasets = [{
                    label: 'Total',
                    data: output,
                    backgroundColor: 'rgba(63, 82, 227, 1)',
